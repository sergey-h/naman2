...
if ( ! class_exists( 'WPEX_Gallery_Metabox' ) ) {
	class WPEX_Gallery_Metabox {
		...
		public function __construct() {
			...
			$this->dir = WPEX_FRAMEWORK_DIR_URI .'meta/gallery-metabox/';
		}
		...
		function css() { ?>
			<style>
				...
				.gallery_images .wpex-gmb-remove {background: #eee url("<?php echo $this->dir; ?>delete.png") center center no-repeat;position: absolute;top: 2px;right: 2px;border-radius: 2px;padding: 2px;display: none;width: 10px;height: 10px;margin: 0;display: none;overflow: hidden;}	
