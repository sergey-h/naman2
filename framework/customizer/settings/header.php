...
$wp_customize->add_control( 'header_height', array(
	...
	'priority'		=> 2,
	'type'			=> 'text',
	'description'	=> __( 'Use this setting to define a fixed header height (Header Style One Only. Use this option ONLY if your want the navigation drop-downs to fall right under the header. Remove the default height (leave this field empty) if you want the header to auto expand depending on your logo height.', 'wpex' )
) );
...
$wp_customize->add_control( 'logo_max_width', array(
	'label'			=> __( 'Logo Max Width', 'wpex' ),
	'section'		=> 'wpex_header_logo',
	'settings'		=> 'logo_max_width',
	'priority'		=> 7,
	'type'			=> 'text',
	'description'	=> __( 'Helps prevent conflicts with your logo and your menu.', 'wpex' ),
) );
