	...
	class WPEX_Theme_Customizer_Styling {
		...
		public function wpex_color_options() {
			...
			$array[] = array(
				...
				'element'	=> '#site-header, #searchform-header-replace, .is-sticky #site-header',
				'style'		=> 'background-color',
				'section'	=> 'wpex_header_styling',
			);
			$array[] = array(
			...
			if ( WPEX_VC_ACTIVE ) {
				...
				$array[] = array(
					...
					'element'	=> '.vcex-caroufredsel-wrap .vcex-caroufredsel-prev, .vcex-caroufredsel-wrap .vcex-caroufredsel-next, .vcex-caroufredsel-wrap .vcex-caroufredsel-prev:hover,.vcex-caroufredsel-wrap .vcex-caroufredsel-next:hover',
					'style'		=> 'background-color',
					'section'	=> 'wpex_visual_composer_styling',
					'transport'	=> 'refresh',
				);
		...
		public function register ( $wp_customize ) {
			...
			$enabled_panels	= $wpex_customizer->panels;
