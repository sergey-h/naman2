		...
		ob_start();
			...
			if( $images ) :
				...
				if ( $grid_style == 'no-margins' ) {
					if ( $columns == '1' ) $columns_class = 'full-width';
					if ( $columns == '2' ) $columns_class = 'one-half';
					if ( $columns == '3' ) $columns_class = 'one-third';
					if ( $columns == '4' ) $columns_class = 'one-fourth';
					if ( $columns == '5' ) $columns_class = 'one-fifth';
					if ( $columns == '6' ) $columns_class = 'one-sixth';
				} else {
					if ( $columns == '1' ) $columns_class = 'span_1_of_1';
					if ( $columns == '2' ) $columns_class = 'span_1_of_2';
					if ( $columns == '3' ) $columns_class = 'span_1_of_3';
					if ( $columns == '4' ) $columns_class = 'span_1_of_4';
					if ( $columns == '5' ) $columns_class = 'span_1_of_5';
					if ( $columns == '6' ) $columns_class = 'span_1_of_6';
				}
...
add_action( 'admin_init', 'vcex_image_grid_shortcode_vc_map' );