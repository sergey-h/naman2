...
if ( ! function_exists( 'vcex_image_carousel_shortcode' ) ) {
	...
	function vcex_image_carousel_shortcode($atts) {
		...
		if( $images ) {
			...
			<div class="<?php echo $add_classes; ?>"<?php echo $unique_id; ?> data-items="<?php echo $items; ?>" data-slideby="<?php echo $items_scroll; ?>" data-nav="<?php echo $arrows; ?>" data-autoplay="<?php echo $auto_play; ?>" data-loop="<?php echo $infinite_loop; ?>" data-autoplay-timeout="<?php echo $timeout_duration ?>" data-center="<?php echo $center; ?>" data-margin="<?php echo intval( $items_margin ); ?>" data-items-tablet="<?php echo $tablet_items; ?>" data-items-mobile-landscape="<?php echo $mobile_landscape_items; ?>" data-items-mobile-portrait="<?php echo $mobile_portrait_items; ?>">
				<?php
				// Loop through images
				$count=-1;
					...
					<div class="wpex-carousel-slide">
						<div class="wpex-carousel-entry-media clr <?php echo $img_classes; ?>">
							...
							if ( 'lightbox' == $thumbnail_link ) { ?>
								<a href="<?php echo $attachment_img_url; ?>" title="<?php echo $attachment_alt; ?>" class="wpex-carousel-entry-img wpex-lightbox">
...
add_action( 'admin_init', 'vcex_image_carousel_shortcode_vc_map' );