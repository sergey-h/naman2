...
function wpex_get_excerpt() {
	_deprecated_function( 'wpex_get_excerpt', '1.6.0' );
}
...
function wpex_next_prev() {
	_deprecated_function( 'wpex_next_prev', '1.6.0', 'get_template_part' );
...
function wpex_page_header() {
	_deprecated_function( 'wpex_page_header', '1.6.0', 'get_template_part' );
}
